...
- 答错：显示易错点提示，可重新答题
- 解锁机制：5/10/15能量时解锁彩虹鱼、斑点鱼、彩虹斑点鱼
...
- **动画系统**：CSS动画实现波纹、泡泡、虾游动；小鱼表情动画（happy类控制嘴巴和眼睛缩放）
...
**fish-game.html 可调参数**：
- 解锁阈值：修改 `updateEnergy()` 函数中的能量值判断（当前为5/10/15）
